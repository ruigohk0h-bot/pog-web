...
const BANZUKE_2YO = {
  ...
  rows: [
    { rank:"横綱", nth:"東", name:"レガメデルヴェント", sex:"牡", sire:"ルヴァンスレーヴ", stable:"美浦・伊坂重信", nkId:"2024106872", move:"☆",
      note:"札幌ダ1700m新馬を圧巻の大差勝ち。近親にダートG1・4勝のゴールドアリュールを持つ砂の名血。2着ホウオウシュウ（砂遊び馬）に力の違いを見せつけ、いきなり横綱昇進。" },
    ...
    { rank:"大関", nth:"東", name:"ウラノグラフィア", sex:"牡", sire:"ナダル", stable:"美浦・宮田敬介", nkId:"2024106700", move:"☆",
      note:"新潟ダ1800m新馬を3馬身差で快勝。2着は同じ砂遊びの指名馬レッドマウロア（ミリオン厩舎）というPOG対決を制した一戦。岩田望来「いいところまで行ける」と太鼓判。" },
    ...
    { rank:"関脇", nth:"東", name:"トゥザファイナル", sex:"牡", sire:"ナダル", stable:"美浦・小島茂之", nkId:"2024106404", move:"☆",
      note:"タイム指数全国2位！札幌1R・2歳未勝利ダ1700mを半馬身差で初勝利。鞍上はルメール、担当はアーモンドアイを育てた元調教師・国枝栄厩務員という感動秘話付き。砂遊び自前の指名馬（ミリオン厩舎）がついに全国区へ。" },
    ...
    { rank:"小結", nth:"西", name:"ユイノリュウギ", sex:"牡", sire:"クリソベリル", stable:"美浦・竹内正洋", move:"☆",
      note:"タイム指数全国3位。新潟2R・2歳未勝利ダ1800mを2馬身半差で勝利。鞍上・木幡初也。" },
    ...
    { rank:"前頭", nth:"三枚目", name:"ウノキボンバイエ", sex:"牡", sire:"ミスチヴィアスアレック", stable:"浦和（地方）", move:"☆",
      note:"タイム指数全国4位。浦和4R・2歳新馬ダ1400mを勝利。地方勢の意地を見せた一頭。" },
    { rank:"前頭", nth:"四枚目", name:"オーリエイト", sex:"牡", sire:"ナダル", nkId:"2024107041", move:"☆",
      note:"タイム指数全国5位。デビュー戦は中京2着も、中京2R・2歳未勝利ダ1800mで1馬身差の初勝利。" },
  ],
};

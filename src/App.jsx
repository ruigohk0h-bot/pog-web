...
const PLAYERS_2627 = [
  {
    ...
    horses:[
      ...
      { no:5,  name:"ルヴァンアレー",      sire:"ルヴァンスレーヴ",      dam:"ラテュロス" },
      { no:6,  name:"ホウオウハピネス",   sire:"Gun Runner",           dam:"Stellar Wind" },
  ...
  },
  {
    id:"P01", name:"前田厩舎", emoji:"🏇",
    horses:[
      { no:1,  name:"コックスコーム",      sire:"ナダル",                dam:"スーブレット" },
      ...
      { no:5,  name:"タイセイシュペール", sire:"ルヴァンスレーヴ", dam:"オーサムウインド" },
      { no:6,  name:"ベリルアンヴォル", sire:"クリソベリル", dam:"プロミストリープ" },
      ...
      { no:10, name:"エピドゥブレ",        sire:"ゴールドドリーム",      dam:"クインアマランサス" },
  ...
  },
  {
    ...
    horses:[
      ...
      { no:8,  name:"コンセントリコ",       sire:"ディスクリートキャット", dam:"セントリフュージ" },
      { no:9,  name:"ツリートッパー",      sire:"ドレフォン",            dam:"ナターレ" },
      { no:10, name:"ハーモニープルーフ",  sire:"ナダル",               dam:"ゴールデンプルーフ" },
  ...
  },
  {
    ...
    horses:[
      ...
      { no:10, name:"クリムゾンペタル", sire:"オルフェーヴル", dam:"フェータルローズ" },
      { no:11, name:"ホーフアイゼン",      sire:"American Pharoah", dam:"Chain of Love" },
      { no:12, name:"ステラガーネット",    sire:"アルクトス",            dam:"シャインガーネット" },
    ],
  },
  {
    id:"P05", name:"田崎厩舎", emoji:"⚡",
...
const STABLE_REPORTS = {
  // 2026年9月号：ムーンベリル・トゥザファイナル・ウラノグラフィアの
  // 勝ち上がりでリーグ上位が入れ替わり。芝で逃したptも各厩舎で明暗。
  P01: { type:"バランス型・芝疑惑あり",
    comment:"ナダル・ルヴァンスレーヴを軸に日米の中距離血統を幅広く採る優等生型。2勝のうちラキアーヴェのダート勝ちのみが実質得点（590pt）で、エスクアドラの勝利は芝のためポイント対象外。リーグ屈指の11/12頭登録という層の厚さはあるが、ダート適性の見極めが今季のカギ。" },
  P02: { type:"フライトライン全力買い",
    comment:"Flightline産駒を3頭指名という思い切った米国全振り路線。デミアンが今季初勝利を挙げロマンの一端を見せたが、まだ点数は伸び悩み中。11/12頭登録と粒は揃っており、覚醒すれば一気の巻き返しが期待できる仕込み中の一軍。" },
  P03: { type:"ダート王道・堅実路線",
    comment:"ニューイヤーズデイ・クリソベリルを2頭ずつ揃えたダートの定番どころ布陣。番付にも入ったムーンベリルが勝ち上がり、芝で稼いでポイント対象外になった馬もゼロと安定感はリーグ随一。着実にポイントを積み上げる優勝候補格。" },
  P04: { type:"日米ハイブリッド型・ナダル推し",
    comment:"ナダルを3頭指名という日本一のナダル推し厩舎。番付関脇のトゥザファイナルがルメール騎乗・アーモンドアイ元主戦コンビの感動秘話付きで初勝利を挙げ、一気に全国区の話題をさらった。マインドユアビスケッツ・クリソベリルの控えにも期待。" },
  P05: { type:"個性派・多様性重視",
    comment:"カリフォルニアクローム、スマートファルコン、オメガパフュームまで他厩舎と被らない独自路線。今季まだ大きな得点源は見えていないが、ダートで走れば一気に台風の目になるポテンシャルは健在。巻き返しに期待。" },
  P06: { type:"良血コレクター型",
    comment:"Flightline、コントレイル、レイデオロと話題性抜群の種牡馬をずらり。番付大関に躍り出たウラノグラフィア（父ナダル）が3馬身差で快勝し、現在ポイントトップを走る好調ぶり。良血の底力を見せつけている。" },
  P07: { type:"米国パワー型",
    comment:"Volatile、Violence、ホットロッドチャーリーと米国のスピード＆パワー血統を厚めに配置。番付にも入ったタクティシアンが勝ち上がったものの、芝で稼いでしまいポイント対象外になった分がリーグ最大級（1,330pt相当）。ダート替わりでの一気の量産体制に期待したいところ。" },
};
...
const BANZUKE_2YO = {
  ...
  updated:  "2026年9月",
  version:  "2026-09-24", // 更新のたびに日付を変更するとバナーで再通知される
  ...
  rows: [
    { rank:"横綱", nth:"東", name:"レガメデルヴェント", sex:"牡", sire:"ルヴァンスレーヴ", stable:"美浦・伊坂重信", nkId:"2024106872", move:"→",
      note:"7/25札幌5R・2歳新馬ダ1700mでデビューし圧巻の大差勝ち。近親にダートG1・4勝のゴールドアリュールを持つ砂の名血。2着ホウオウシュウ（砂遊び馬）に力の違いを見せつけ、いきなり横綱昇進。" },
    { rank:"横綱", nth:"西", name:"ユイノエスポワール", sex:"牡", sire:"ディスクリートキャット", move:"—",
      note:"6/14東京4R・2歳新馬ダ1400mでデビューし上がり最速で差し切り。タイム指数堂々の1位。" },
    { rank:"大関", nth:"東", name:"ウラノグラフィア", sex:"牡", sire:"ナダル", stable:"美浦・宮田敬介", nkId:"2024106700", move:"→",
      note:"8/30新潟2R・2歳新馬ダ1800mでデビューし3馬身差で快勝。2着は同じ砂遊びの指名馬レッドマウロア（ミリオン厩舎）というPOG対決を制した一戦。岩田望来「いいところまで行ける」と太鼓判。" },
    { rank:"大関", nth:"西", name:"ウィンターブリーズ", sex:"牝", sire:"ホットロッドチャーリー", stable:"成田厩舎（砂遊び馬）", nkId:"2024106106", move:"☆",
      note:"9/20中山1R・2歳未勝利ダ1800mを馬なりのまま勝利し、ダート1800m2歳レコードを更新！デビューは芝(6/6東京)、2戦目も芝2着からのダート転向初戦での快挙。ホットロッドチャーリー産駒の底力を見せつけ新大関に。" },
    { rank:"関脇", nth:"東", name:"ポッドビート", sex:"牡", sire:"ナッシュビル", stable:"美浦・伊藤圭三", nkId:"2024108315", move:"↘",
      note:"9/5中山6R・2歳新馬ダ1200mで10馬身差の圧勝デビュー！1番人気に応え鞍上・武豊も「いいスピードがありますね」と太鼓判。父ナッシュビルにとってJRA初勝利という記念すべき一戦。" },
    { rank:"関脇", nth:"西", name:"タケルレジェンド", sex:"牡", sire:"パイロ", stable:"栗東・高柳大輔", nkId:"2024100730", move:"↘",
      note:"7/5小倉6R・2歳新馬でデビューし逃げ切りV。25年NHKマイルC馬パンジャタワーの半弟という良血で、川田将雅も素質を高評価。" },
    { rank:"小結", nth:"東", name:"トゥザファイナル", sex:"牡", sire:"ナダル", stable:"美浦・小島茂之", nkId:"2024106404", move:"↘",
      note:"6/14デビュー(芝1400m4着)後、8/22札幌1R・2歳未勝利ダ1700mを半馬身差で初勝利。鞍上はルメール、担当はアーモンドアイを育てた元調教師・国枝栄厩務員という感動秘話付き。砂遊び自前の指名馬（ミリオン厩舎）がついに全国区へ。" },
    { rank:"小結", nth:"西", name:"ワンスフォーユー", sex:"牝", sire:"ナダル", stable:"栗東・高橋文雅", nkId:"2024105753", move:"☆",
      note:"9/21阪神4R・2歳新馬ダ1400mを2秒半差の大差勝ち。最後は流したままの内容で、絶好調ナダル産駒（直近1ヶ月で6戦4勝）を象徴する一頭として新小結に。" },
    { rank:"前頭", nth:"筆頭", name:"コンテミュール", sex:"牝", sire:"ルヴァンスレーヴ", stable:"美浦・村田一誠", nkId:"2024106660", move:"↘",
      note:"7/4福島6R・2歳新馬でデビューし逃げ切り。1番人気クロダテ（砂遊び馬）を撃破した伏兵。" },
    { rank:"前頭", nth:"二枚目", name:"ロジアコース", sex:"牡", sire:"ロジユニヴァース", stable:"美浦・加藤征弘", nkId:"2024106754", move:"↘",
      note:"タイム指数全国1位。7/19函館・芝1800mでデビューし7着も、初ダート挑戦の9/5札幌1R・2歳未勝利ダ1700mで単勝1.1倍の圧倒的人気馬を6馬身差で撃破。ただし通算まだ2戦と実績の蓄積はこれからの一頭。" },
    { rank:"前頭", nth:"三枚目", name:"ノリヤンモーニン", sex:"牡", sire:"モーニン", stable:"栗東・佐藤悠", move:"↘",
      note:"6/20函館6R・2歳新馬でデビューし5馬身差で圧勝。浜中俊も「次も期待できます」と太鼓判。" },
    { rank:"前頭", nth:"四枚目", name:"ユイノリュウギ", sex:"牡", sire:"クリソベリル", stable:"美浦・竹内正洋", move:"↘",
      note:"8/22新潟2R・2歳未勝利ダ1800mを2馬身半差で勝利。鞍上・木幡初也。" },
    { rank:"前頭", nth:"五枚目", name:"ムーンベリル", sex:"牝", sire:"クリソベリル", stable:"長谷部厩舎（砂遊び馬）", nkId:"2024106276", move:"↘",
      note:"6/27福島6R・2歳新馬でデビュー(エランヴィータと同レース)後、7/19中京ダ1150mを快勝し待望の初勝利！砂遊び期待の一頭。" },
    { rank:"前頭", nth:"六枚目", name:"エランヴィータ", sex:"牝", sire:"シャンハイボビー", move:"↘",
      note:"6/27福島6R・2歳新馬ダ1150mでデビューし勝利。ムーンベリル（砂遊び馬）を1馬身半下した実力馬。" },
    { rank:"前頭", nth:"七枚目", name:"オーリエイト", sex:"牡", sire:"ナダル", nkId:"2024107041", move:"↘",
      note:"8/2中京2R・2歳新馬でデビュー2着も、8/29中京2R・2歳未勝利ダ1800mで1馬身差の初勝利。" },
  ],
};
...
function StallionScreen({ stallions, results, stallionLeading, azkiBubble }) {
  ...
  const azkiRelevant = azkiBubbleSires
    .filter(s => pogSireNames.has(s.name))
        ...
        <div>
          ...
          <div style={{ background:"#fff", borderRadius:10, padding:"12px 10px 6px", marginBottom:16, boxShadow:"0 1px 4px rgba(0,0,0,0.08)" }}>
            {azkiRelevant.length === 0 ? (
              ...
              // ノード生成（本来の位置を記憶）
              const nodes = azkiRelevant.map(s => {
                const r = 4 + (s.n / nMax) * 9;
                return {
                  s, r,
                  ox: px(s.turfAptitude), oy: py(s.dirtPrizePerRun), // 本来の位置
                  x: px(s.turfAptitude),  y: py(s.dirtPrizePerRun),
                  // ラベルを含めた占有ボックス（半幅・半高）
                  hw: Math.max(r, (s.name.length * 8.6) / 2) + 5,
                  hh: r + 13,
                };
              });
              // 重なり解消：ラベル込みのボックス同士を反復的に押し広げる
              for (let it = 0; it < 200; it++) {
                ...
                for (let i = 0; i < nodes.length; i++) {
                  for (let j = i + 1; j < nodes.length; j++) {
                    ...
                    const overX = a.hw + b.hw - Math.abs(dx);
                    const overY = a.hh + b.hh - Math.abs(dy);
                    if (overX > 0 && overY > 0) {
                      moved = true;
                      // 貫入が浅い軸方向に押し出す（縦方向を優先しやすくして横幅節約）
                      if (overY * 1.4 < overX) {
                ...
                // 画面内に収める＆本来の位置へ弱く引き戻す
                for (const n of nodes) {
                  n.x += (n.ox - n.x) * 0.03;
                  n.y += (n.oy - n.y) * 0.03;
                  n.x = Math.min(Math.max(n.x, n.hw + 2), W - n.hw - 2);
                  n.y = Math.min(Math.max(n.y, n.hh + 4), H - PAD - n.r - 2);
                }
                if (!moved) break;
              }
              ...
              return (
                <svg viewBox={`0 0 ${W} ${H}`} width="100%" height={H} style={{ display:"block" }}>
                  ...
                  {/* ずらした円と本来の位置を結ぶ細い線 */}
                  {nodes.map(n => (
                    Math.hypot(n.x - n.ox, n.y - n.oy) > 6 && (
                      <line key={"l"+n.s.name} x1={n.ox} y1={n.oy} x2={n.x} y2={n.y}
                        stroke="#ccc" strokeWidth={0.8} strokeDasharray="2,2" />
                    )
                  ))}
                  {nodes.map(n => {
                    const dirtWins = n.s.dirtPrizePerRun > n.s.turfPrizePerRun;
                    return (
                      <g key={n.s.name}>
                        <circle cx={n.x} cy={n.y} r={n.r}
                          fill={dirtWins ? "rgba(122,74,30,0.55)" : "rgba(42,122,58,0.5)"}
                          stroke={dirtWins ? G.dirtDark : "#2a7a3a"} strokeWidth={1} />
                        <text x={n.x} y={n.y + n.r + 9} fontSize={8}
                          fill={dirtWins ? G.dirtDark : "#2a7a3a"} fontWeight={700} textAnchor="middle">
                          {n.s.name}
                        </text>
                      </g>
                    );
            ...
            <div style={{ padding:"8px 4px 4px", fontSize:9.5, color:"#bbb", textAlign:"center" }}>
              茶色＝ダート適性優勢　緑＝芝適性優勢（円が大きいほど産駒頭数が多い）<br/>
              ※見やすさのため円の位置を調整しています。点線は本来の位置
            </div>
          </div>
...
export default function App() {
  ...
  if (tab === "ranking") {
    ...
    title = "ダート種牡馬研究";
    content = <StallionScreen stallions={stallions} results={results} stallionLeading={stallionLeading} azkiBubble={azkiBubble} />;
  } else if (tab === "game") {
    title = "砂遊びゲーム";
    content = <GameScreen />;
  } else {

...
const STABLE_REPORTS = {
  ...
  P03: { type:"ダート王道・堅実路線",
    comment:"ニューイヤーズデイ・クリソベリルを2頭ずつ揃えたダートの定番どころ布陣。番付にも入ったムーンベリルが勝ち上がり、芝での取りこぼしもゼロと安定感はリーグ随一。着実にポイントを積み上げる優勝候補格。" },
  ...
  P07: { type:"米国パワー型",
    comment:"Volatile、Violence、ホットロッドチャーリーと米国のスピード＆パワー血統を厚めに配置。番付にも入ったタクティシアンが勝ち上がったものの、芝での取りこぼしがリーグ最大級。ダート替わりでの一気の量産体制に期待したいところ。" },
};

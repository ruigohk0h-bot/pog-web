...
const HORSES_P03 = [
  ...
  { no:3,  name:"ヘリテージブルーム",record:"2-2-3-1", pt:2540,  active:false },
  { no:11, name:"ゴールドバローズ",  record:"1-2-0-1", pt:1180,  active:false },
  { no:1,  name:"エクストラプッシュ",record:"1-1-0-7", pt:1087,  active:false },
  { no:7,  name:"エコロボルト",      record:"1-1-0-3", pt:889,   active:true  },
  { no:4,  name:"エジプシャンマウ",  record:"1-0-0-0", pt:750,   active:true  },
  { no:12, name:"アメリカンコール",  record:"1-0-0-1", pt:750,   active:false },
  { no:2,  name:"セスティーナ",      record:"0-1-1-1", pt:430,   active:true  },
  { no:8,  name:"ゲレイロ",          record:"0-0-0-7", pt:148,   active:false },
  { no:5,  name:"サンライズメジェド",record:"0-0-0-0", pt:0,     active:true  },
...
const HORSES_P05 = [
  ...
  { no:2,  name:"サトノボヤージュ",   record:"4-1-1-0", pt:8570,  active:false },
  { no:12, name:"テーオーグレーザー", record:"2-2-2-1", pt:2980,  active:true  },
  { no:1,  name:"カットソロ",         record:"1-1-2-1", pt:1290,  active:false },
  { no:3,  name:"ジャスティンダラス", record:"1-1-0-1", pt:860,   active:false },
  { no:10, name:"フリーガー",         record:"1-0-0-2", pt:750,   active:false },
  { no:9,  name:"エコログロウ",       record:"1-0-1-2", pt:740,   active:false },
  { no:8,  name:"ミリオンヴォイス",   record:"1-0-0-1", pt:655,   active:true  },
  { no:11, name:"ゾネブルーム",       record:"0-0-2-1", pt:300,   active:true  },
  { no:6,  name:"ローズスマッシュ",   record:"0-0-0-1", pt:240,   active:true  },

...
const BANZUKE_2YO = {
  ...
  updated:  "2026年9月",
  version:  "2026-09-14", // 更新のたびに日付を変更するとバナーで再通知される
  ...
  rows: [
    ...
    { rank:"大関", nth:"西", name:"ポッドビート", sex:"牡", sire:"ナッシュビル", stable:"美浦・伊藤圭三", nkId:"2024108315", move:"☆",
      note:"9/5中山6R・2歳新馬ダ1200mで10馬身差の圧勝デビュー！1番人気に応え鞍上・武豊も「いいスピードがありますね」と太鼓判。父ナッシュビルにとってJRA初勝利という記念すべき一戦で新大関に。" },
    { rank:"関脇", nth:"東", name:"タケルレジェンド", sex:"牡", sire:"パイロ", stable:"栗東・高柳大輔", nkId:"2024100730", move:"↘",
      note:"7/5小倉6R・2歳新馬でデビューし逃げ切りV。25年NHKマイルC馬パンジャタワーの半弟という良血で、川田将雅も素質を高評価。" },
    { rank:"関脇", nth:"西", name:"トゥザファイナル", sex:"牡", sire:"ナダル", stable:"美浦・小島茂之", nkId:"2024106404", move:"↘",
    ...
    { rank:"小結", nth:"東", name:"コンテミュール", sex:"牝", sire:"ルヴァンスレーヴ", stable:"美浦・村田一誠", nkId:"2024106660", move:"↘",
      note:"7/4福島6R・2歳新馬でデビューし逃げ切り。1番人気クロダテ（砂遊び馬）を撃破した伏兵。" },
    { rank:"小結", nth:"西", name:"ロジアコース", sex:"牡", sire:"ロジユニヴァース", stable:"美浦・加藤征弘", nkId:"2024106754", move:"☆",
      note:"タイム指数全国1位。7/19函館・芝1800mでデビューし7着も、初ダート挑戦の9/5札幌1R・2歳未勝利ダ1700mで単勝1.1倍の圧倒的人気馬を6馬身差で撃破。ただし通算まだ2戦と実績の蓄積はこれからの一頭。" },
    { rank:"前頭", nth:"筆頭", name:"ノリヤンモーニン", sex:"牡", sire:"モーニン", stable:"栗東・佐藤悠", move:"↘",
      note:"6/20函館6R・2歳新馬でデビューし5馬身差で圧勝。浜中俊も「次も期待できます」と太鼓判。" },
    { rank:"前頭", nth:"二枚目", name:"ユイノリュウギ", sex:"牡", sire:"クリソベリル", stable:"美浦・竹内正洋", move:"↘",
      note:"8/22新潟2R・2歳未勝利ダ1800mを2馬身半差で勝利。鞍上・木幡初也。" },
    { rank:"前頭", nth:"三枚目", name:"ムーンベリル", sex:"牝", sire:"クリソベリル", stable:"長谷部厩舎（砂遊び馬）", nkId:"2024106276", move:"↘",
      note:"6/27福島6R・2歳新馬でデビュー(エランヴィータと同レース)後、7/19中京ダ1150mを快勝し待望の初勝利！砂遊び期待の一頭。" },
    { rank:"前頭", nth:"四枚目", name:"エランヴィータ", sex:"牝", sire:"シャンハイボビー", move:"↘",
      note:"6/27福島6R・2歳新馬ダ1150mでデビューし勝利。ムーンベリル（砂遊び馬）を1馬身半下した実力馬。" },
    { rank:"前頭", nth:"五枚目", name:"オーリエイト", sex:"牡", sire:"ナダル", nkId:"2024107041", move:"↘",

...
const BANZUKE_2YO = {
  ...
  rows: [
    ...
    { rank:"大関", nth:"西", name:"タケルレジェンド", sex:"牡", sire:"パイロ", stable:"栗東・高柳大輔", nkId:"2024100730", move:"↘",
      note:"7/5小倉6R・2歳新馬でデビューし逃げ切りV。25年NHKマイルC馬パンジャタワーの半弟という良血で、川田将雅も素質を高評価。" },
    { rank:"関脇", nth:"東", name:"トゥザファイナル", sex:"牡", sire:"ナダル", stable:"美浦・小島茂之", nkId:"2024106404", move:"☆",
      note:"タイム指数全国2位！6/14デビュー(芝1400m4着)後、8/22札幌1R・2歳未勝利ダ1700mを半馬身差で初勝利。鞍上はルメール、担当はアーモンドアイを育てた元調教師・国枝栄厩務員という感動秘話付き。砂遊び自前の指名馬（ミリオン厩舎）がついに全国区へ。" },
    { rank:"関脇", nth:"西", name:"コンテミュール", sex:"牝", sire:"ルヴァンスレーヴ", stable:"美浦・村田一誠", nkId:"2024106660", move:"↘",
      note:"7/4福島6R・2歳新馬でデビューし逃げ切り。1番人気クロダテ（砂遊び馬）を撃破した伏兵。" },
    { rank:"小結", nth:"東", name:"ノリヤンモーニン", sex:"牡", sire:"モーニン", stable:"栗東・佐藤悠", move:"↘",
      note:"6/20函館6R・2歳新馬でデビューし5馬身差で圧勝。浜中俊も「次も期待できます」と太鼓判。" },
    { rank:"小結", nth:"西", name:"ユイノリュウギ", sex:"牡", sire:"クリソベリル", stable:"美浦・竹内正洋", move:"☆",
      note:"タイム指数全国3位。8/22新潟2R・2歳未勝利ダ1800mを2馬身半差で勝利。鞍上・木幡初也。" },
    ...
    { rank:"前頭", nth:"三枚目", name:"オーリエイト", sex:"牡", sire:"ナダル", nkId:"2024107041", move:"☆",
      note:"タイム指数全国4位（旧5位から一つ繰り上げ）。8/2中京2R・2歳新馬でデビュー2着も、8/29中京2R・2歳未勝利ダ1800mで1馬身差の初勝利。" },
  ],
};

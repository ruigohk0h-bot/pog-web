...
# ============================================================
HORSE_PLAYER = {
    # 2022-23シーズン（2020年生まれ）
    # P01 前田厩舎
    "ユディタム":"P01","エクロジャイト":"P01","ジュドー":"P01","サンデュエル":"P01",
    "イエルバブエナ":"P01","ルージュイストリア":"P01","ヴォーハンマー":"P01",
    "ヴァンビスタ":"P01","エンブレム":"P01","ランドオブサンド":"P01",
    # P02 川村厩舎
    "スクーパー":"P02","ミスティックロア":"P02","カレンアルカンタラ":"P02","モズアカボス":"P02",
    "バイリヴレ":"P02","ワインワインレッド":"P02","ダグフォース":"P02","ゴールデンマイク":"P02",
    "カミノモラド":"P02","メガラニカ":"P02",
    # P03 長谷部厩舎
    "メイクザビート":"P03","メジェド":"P03","レイズカイザー":"P03","ナムラテディー":"P03",
    "サクセスハチハチ":"P03","メイショウノブカ":"P03","コバノスタンリー":"P03",
    "デュアルモーション":"P03","カーメルビーチ":"P03","ロジザキア":"P03",
    # P04 ミリオン厩舎
    "ミラクルティアラ":"P04","ルルシュシュ":"P04","ミラクルキャッツ":"P04","ヴァレンティヌス":"P04",
    "スターグロウ":"P04","マスグラバイト":"P04","ジャスティンカプリ":"P04","キュビドン":"P04",
    "ノルドウェスト":"P04","オンクルヨリ":"P04",

    # 2023-24シーズン（2021年生まれ）
    # P01
    "サトノフェニックス":"P01","ベンナヴェローチェ":"P01","オコタンペ":"P01","ノットイナフ":"P01",
    "ソニックライン":"P01","アルシミスト":"P01","フルレゾン":"P01","クラリファイ":"P01",
    "ジャンドル":"P01","メネラオス":"P01","クセノポン":"P01","レイヌドサーブル":"P01",
    # P02
    "エコロガイア":"P02","ルディック":"P02","メイショウホウレン":"P02","エスカル":"P02",
    "ダンツティアラ":"P02","インテルメディオ":"P02","ボンピエ":"P02","バリッドキャリア":"P02",
    "ワインダモ":"P02","モッドフレイム":"P02","リムショット":"P02","シングマイブルース":"P02",
    # P03
    "ビューロマジック":"P03","カラフルメロディー":"P03","ナファロア":"P03","サンダーアラート":"P03",
    "サウンドアレグリア":"P03","メイショウソウタ":"P03","ヘニーズネフュー":"P03","リアルモハメド":"P03",
    "アショカ":"P03","ハードタック":"P03","ソングライター":"P03","ウインクリード":"P03",
    # P04
    "アンデスビエント":"P04","テーオードラッカー":"P04","ダノンスウィッチ":"P04","マックスセレナーデ":"P04",
    "ミッキードラマー":"P04","アタラヨ":"P04","リルフロスト":"P04","キツネノヨメイリ":"P04",
    "タイセイマーシャル":"P04","プラストパローズ":"P04","ホウオウラムセス":"P04","コヴィーニャ":"P04",
    # P05
    "エルフストラック":"P05","センチュリボンド":"P05","リューデスハイム":"P05","ヴェルトラウム":"P05",
    "ケイアイアルタイル":"P05","ウインイメル":"P05","アセレラシオン":"P05","トニーテソーロ":"P05",
    "フェリーニ":"P05","リベルテ":"P05","テトラード":"P05","アウトドライブ":"P05",
    # P07
    "アンクエンチャブル":"P07","タンゴバイラリン":"P07","ウェットシーズン":"P07","ダノンケイツー":"P07",
    "オペラブラージュ":"P07","クリティカルヒット":"P07","ダイシンバースディ":"P07","ビスクウィザード":"P07",
    "ディフェリ":"P07","ウェイトウゴー":"P07","パルログ":"P07","アイウィル":"P07",

    # 2024-25シーズン（2022年生まれ）
    # P01
    "クレーキング":"P01","ジャナドリア":"P01","グランジョルノ":"P01","アローオブライト":"P01",
    "ソリスクラヴィス":"P01","ヤノマスティーロ":"P01","ボヌールキャッツ":"P01","フォンデネージュ":"P01",
    "ラピッドグロウス":"P01","エンジェルラダー":"P01","ジャスティンロング":"P01","フランシュフック":"P01",
    # P02
    "ニューファウンド":"P02","シホノベルフェット":"P02","クニノハッピー":"P02","バタール":"P02",
    "モレポブラーノ":"P02","マーキュリーダイム":"P02","ホウオウアンジュ":"P02","タンテドヴィーヴル":"P02",
    "ジャスティントレノ":"P02","レジェンダイズ":"P02","テイエムライダー":"P02","アーロッタレット":"P02",
    # P03
    "ミストレス":"P03","レイナデアルシェラ":"P03","イガッチ":"P03","サンダーロード":"P03",
    "チムニートップス":"P03","サニーサルサ":"P03","シルフズミスチーフ":"P03","ビービーバザーク":"P03",
    "カルデライト":"P03","パルジール":"P03","グレインワーク":"P03","メムエクラ":"P03",
    # P04
    "ルクソールカフェ":"P04","モズナナスター":"P04","プロミストジーン":"P04","マイネルフーガ":"P04",
    "マリアイリダータ":"P04","ダノンヴェステル":"P04","グレイテストソング":"P04","ヴィンブルレー":"P04",
    "スマートカイロス":"P04","コスモガラニカ":"P04","マリアディオーサ":"P04","ランフォザブライド":"P04",
    # P05
    "カナルビーグル":"P05","トリポリタニア":"P05","アートレスマインド":"P05","ポルトテソーロ":"P05",
    "ステイクオール":"P05","グレイスザクラウン":"P05","レッドソニード":"P05","ソーツアウト":"P05",
    "パレアレス":"P05","ツァイトガイスト":"P05","グランダイト":"P05","レッドエソール":"P05",
    # P07
    "ダノンフィーゴ":"P07","グランドプラージュ":"P07","ベンヌ":"P07","ダニエルバローズ":"P07",
    "オンクラウドナイン":"P07","サルタール":"P07","スキュア":"P07","ケイアイブイスリー":"P07",
    "アインブレーゲン":"P07","チェインズモーカー":"P07","チームビルディング":"P07","ブランクシート":"P07",
